            ...
            <div className="w-full max-w-sm">
                <div className="bg-white border border-[#E7E5E4] rounded-lg p-6 sm:p-8 text-left">
                    ...
                    <div className="text-center mb-6 space-y-1">
                        ...
                        <h1 className="text-lg font-semibold text-[#1C1917]">Welcome Back</h1>
                        <p className="text-xs text-[#78716C]">Sign in to your InterviewAI account</p>
                    </div>
                    ...
                    <p className="text-center text-[#78716C] text-xs mt-5">
                        ...
                        <Link to="/register" className="text-orange-600 hover:underline font-medium">Get Started</Link>
                    </p>
                </div>
            </div>
        </div>
