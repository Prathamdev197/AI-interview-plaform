...
const Home = () => {
    ...
    return (
        <div className="min-h-screen pt-24">
            ...
            <section className="bg-[#FAFAF9] border-b border-[#E7E5E4] py-16 sm:py-24 px-4 sm:px-6">
                <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
                    ...
                    <div className="md:col-span-7 space-y-6 text-left">
                        <div className="inline-flex items-center gap-2 text-xs font-medium text-stone-600 bg-white px-3 py-1 rounded-md border border-[#E7E5E4]">
                            <span className="w-1.5 h-1.5 rounded-full bg-orange-600"></span>
                            AI Technical Interview Practice
                        </div>

                        <h1 className="text-3xl sm:text-5xl font-semibold text-[#1C1917] tracking-tight leading-[1.15]">
                            Practice technical interviews with structured AI feedback
                        </h1>

                        <p className="text-sm sm:text-base text-[#78716C] leading-relaxed max-w-lg">
                        ...
                        <div className="flex items-center gap-3 text-sm pt-1">
                            {user ? (
                                <Link
                                    to="/dashboard"
                                    className="bg-orange-600 hover:bg-orange-700 text-white font-medium px-5 py-2.5 rounded-md flex items-center gap-2 transition"
                                >
                                ...
                                <>
                                    ...
                                    <Link
                                        to="/login"
                                        className="border border-[#E7E5E4] hover:bg-stone-100 text-[#1C1917] font-medium px-5 py-2.5 rounded-md transition"
                                    >
                                        Sign in
                                    </Link>
                                </>
                    ...
                    <div className="md:col-span-5">
                        <div className="bg-white border border-[#E7E5E4] rounded-lg p-5 shadow-xs text-left space-y-4">
                            <div className="flex items-center justify-between text-xs text-[#78716C] border-b border-[#E7E5E4] pb-2.5">
                                <span className="font-semibold uppercase tracking-wider text-orange-600">Question 3 of 10</span>
                            ...
                            <div className="bg-[#FAFAF9] border border-[#E7E5E4] rounded-md p-3 text-xs text-stone-600 leading-relaxed font-mono">
                            ...
                            <div className="flex items-center justify-between pt-1 border-t border-[#E7E5E4] text-xs">
                                ...
                                <span className="text-[#78716C]">Evaluated by Gemini AI</span>
                            </div>
                        </div>
                    </div>
            ...
            <section className="bg-white py-16 sm:py-20 px-4 sm:px-6 border-b border-[#E7E5E4]">
                <div className="max-w-5xl mx-auto space-y-10">
                    <div className="text-left space-y-1">
                        ...
                        <h2 className="text-xl sm:text-3xl font-semibold text-[#1C1917] tracking-tight">How InterviewAI works</h2>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                        <div className="space-y-2">
                            <div className="text-xs font-mono font-semibold text-stone-400">01</div>
                            <h3 className="text-base font-semibold text-[#1C1917]">Select your role track</h3>
                        ...
                        <div className="space-y-2">
                            ...
                            <h3 className="text-base font-semibold text-[#1C1917]">Type or speak your answer</h3>
                            <p className="text-xs sm:text-sm text-[#78716C] leading-relaxed">
                        ...
                        <div className="space-y-2">
                            ...
                            <h3 className="text-base font-semibold text-[#1C1917]">Receive structured evaluation</h3>
                            <p className="text-xs sm:text-sm text-[#78716C] leading-relaxed">
            ...
            {/* Footer */}
            <footer className="bg-white py-10 px-4 sm:px-6 text-xs sm:text-sm text-[#78716C]">
